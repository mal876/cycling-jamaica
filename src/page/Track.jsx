      ...
      <div className=' md:items-center  md:text-left sm:max-xl-p-9 m-12'>
        ...
        <div className='border border-black w-3/4 shadow-lg hover:translate-x-4 duration-300'>
              ...
              <p className='text-lg tracking-light px-12 p-5 font-semibold'>
                ...
                Couva, Trinidad and Tobago <br />
                Jerome Forrest and Andrew Ramsey <br />
                Men's Elite - Madison <br />
                Bronze
              </p>
        </div>
        <br /><br />
        <div className='border border-black w-3/4 shadow-lg hover:translate-x-4 duration-300'>
              ...
              <p className='text-lg tracking-light px-12 p-5 font-semibold'>
                2022 Caribbean Track Championships <br />
                Couva, Trinidad and Tobago <br />
                Abubakr Lamin WRIGHT, Malik Reid and Zoe Boyd <br />
                Men's Elite Team Sprint <br />
                Bronze
              </p>
        </div>
        <br /><br />
